      ...
      <>
        <div className="min-h-[40vh] my-8 flex flex-col lg:flex-row gap-8 items-center">
          <div className="lg:mr-auto max-w-[42rem]">
            ...
            <p className="mb-4">
              It's a wonderful experience designing web apps interfaces with
              Figma - my powerful UI design tool of choice.
            </p>
            <p>
        ...
        <div className="min-h-[40vh] my-8 flex flex-col lg:flex-row gap-8 items-center">
          ...
          <div className="lg:ml-auto max-w-[42rem]">
            ...
            <p className="mb-4">
              ...
              usually go with React or Next.js for their modern approach to
              split code into reusable components - it also makes other
        ...
        <div className="min-h-[40vh] my-8 flex flex-col lg:flex-row gap-8 items-center">
          <div className="lg:mr-auto max-w-[42rem]">
            ...
            <p className="mb-4">
              A need to have a blog or someplace to store your data and making
              it available to your users might arise. My preferred choice is to
              keep working with Javascript and develop simple Node.js + MongoDB
              APIs.
            </p>
          </div>
          <img
