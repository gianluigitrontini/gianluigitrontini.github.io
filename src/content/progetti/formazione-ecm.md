...
description: "Continuing-education mobile app for licensed medical professionals, active across several Italian regions (Veneto, Piemonte, Sardegna, Valle d'Aosta, Lazio, Trentino-Alto Adige). I owned ongoing maintenance and redesign work — fixing critical UX friction points, resolving longstanding bugs, and shipping updates both across iOS (Xcode) and Android (Android Studio) and OTA updates for the frontend bundle."
