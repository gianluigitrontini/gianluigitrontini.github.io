...
// // import type { ProjectInterface } from "../components/Homepage/Projects/Projects";
...
//     return (
//       <Link to={"/#projects"} className="hidden lg:block lg:fixed top-8 left-4">
...
//   } else {
//     return (
//       <Link to={"/#projects"} className="block lg:hidden">
